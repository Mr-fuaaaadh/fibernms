import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, aV as ClipboardList, a3 as Badge, aW as ShieldAlert, af as User, as as CreditCard, ai as Search, X, T as TriangleAlert, aI as Info, N as Network, ab as Shield, C as ChevronDown, a4 as ChevronRight } from "./index-RpWpgnOS.js";
...
import { M as Monitor } from "./monitor-Dkrod3zy.js";
...
function PlatformAudit() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-5 max-w-[1400px] mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex rounded-md border border-border/50 overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { className: "p-3 flex flex-wrap gap-2.5 items-center", children: [
    ...
    viewMode === "timeline" ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: paged.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { className: "flex flex-col items-center py-16 gap-3", children: [
      ...
      event.id
    )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(GlassCard, { className: "overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs", children: [
