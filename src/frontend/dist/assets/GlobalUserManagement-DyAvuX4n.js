import { c as createLucideIcon, f as useIsMobile, r as reactExports, j as jsxRuntimeExports, aL as Users, X, aZ as ChevronLeft, ae as ChevronRight, a_ as Skeleton, ad as Badge, F as FileText, M as MapPin, e as cn, ai as Shield, i as ChevronDown, h as Clock, a$ as LogOut, T as TriangleAlert } from "./index-DzTbe00m.js";
import { G as GlassCard } from "./GlassCard-BsXifIi3.js";
import { B as Button } from "./button-BTPnF9HH.js";
import { C as Checkbox } from "./checkbox-BZv1OB1H.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle } from "./dialog-DOmhennD.js";
import { I as Input } from "./input-CYyqw3v1.js";
import { L as Label } from "./label-b9eYLeKX.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent, P as Progress } from "./tabs-BPQXF2Qe.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-bwO-D03Q.js";
import { S as Separator } from "./separator-DBPvvUPh.js";
import { T as Textarea } from "./textarea-CvbpEZ6d.js";
import { k as MOCK_ADMIN_USERS, M as MOCK_COMPANIES } from "./superAdminMockData-SJ6Z2k0y.js";
import { D as Download } from "./download-BWu6zGdC.js";
import { U as Upload } from "./upload-CR2OQ4vg.js";
import { U as UserPlus, b as UserCheck, a as UserMinus } from "./user-plus-DCdyzx76.js";
import { W as Wifi } from "./wifi-Dj4vP9K-.js";
import { F as Funnel } from "./funnel-BWUBsfPC.js";
import { K as KeyRound, S as ShieldOff } from "./shield-off-Dr-RwhP_.js";
import { C as ChevronUp } from "./chevron-up-Byyb8MGj.js";
import { W as WifiOff } from "./wifi-off-97btnmNc.js";
import { C as CircleCheck } from "./circle-check-b4dQubu8.js";
import { P as Plus } from "./plus-D4Ds32uf.js";
import { M as Mail } from "./mail-CROgMbS7.js";
import { C as CircleX } from "./circle-x-5B2NlWXE.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground truncate", children: user.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Badge,
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1 flex-wrap", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground truncate", children: user.company }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Badge,
                    {
                      className: cn(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end gap-1 flex-shrink-0", children: [
                user.mfaEnabled ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "w-3.5 h-3.5 text-emerald-400" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldOff, { className: "w-3.5 h-3.5 text-muted-foreground/30" }),
        ...
        expanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border/20 px-4 pb-4 pt-3 space-y-3 bg-muted/5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 text-[11px]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-muted-foreground", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: user.region })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-3 h-3 flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: relativeTime(user.lastLogin) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Wifi, { className: "w-3 h-3 flex-shrink-0" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "w-3 h-3 flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                "MFA ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
            user.activeSessions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                variant: "outline",
                size: "sm",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                className: cn(
                  ...
                  user.status === "active" ? "border-red-500/30 text-red-400 hover:bg-red-500/10" : "border-emerald-500/30 text-emerald-400 hover:bg-emerald-500/10"
                ),
...
function GlobalUserManagement() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 md:p-6 space-y-4 md:space-y-5 max-w-[1600px] mx-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Bulk Import" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Invite User" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sm:hidden", children: "Invite" })
            ]
          }
        )
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(GlassCard, { className: "p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full sm:min-w-[220px] sm:flex-1 sm:max-w-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 overflow-x-auto pb-1 sm:pb-0 w-full sm:w-auto flex-nowrap sm:flex-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Select,
          {
            value: companyFilter,
    ...
    isMobile ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", "data-ocid": "user-card-list", children: [
      pageUsers.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
      ...
      ) : pageUsers.map((user, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        UserCard,
        {
          user,
          index: idx + 1,
      ...
      filtered.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
          pageStart + 1,
          "–",
          pageEnd,
