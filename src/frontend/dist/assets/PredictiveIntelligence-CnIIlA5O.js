import { c as createLucideIcon, u as useNetworkStore, n as useNavigate, r as reactExports, j as jsxRuntimeExports, A as AnimatePresence, m as motion, an as Brain, a as cn, d as Activity, ai as Zap, e as Cpu, ab as Radio, q as ChevronRight, ah as TrendingUp } from "./index-BhX-NLFL.js";
import { G as GlassCard } from "./GlassCard-C7Gd1A09.js";
import { R as ResponsiveContainer, T as Tooltip, B as Bar, C as Cell, a as ReferenceDot } from "./generateCategoricalChart-Cd_4XozO.js";
...
function RiskDistributionChart({ alerts }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { elevated: true, className: "p-5 h-full", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-[400px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 160, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      BarChart,
      {
        data,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "count", name: "Devices", radius: [4, 4, 0, 0], children: data.map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Cell,
            {
