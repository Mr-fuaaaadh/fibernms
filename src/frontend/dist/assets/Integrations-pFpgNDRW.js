import { j as jsxRuntimeExports, aD as FeatureFlag, aE as Key, d as Activity, r as reactExports, T as TriangleAlert, ae as Badge, l as Clock, ai as Zap, a as cn, aF as Settings, aG as Link, s as CircleAlert } from "./index-BhX-NLFL.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell, U as Unplug, Z as ZabbixConfigSheet } from "./ZabbixConfigSheet-2JJKnFdZ.js";
import { F as FeatureGate } from "./PlanComparisonModal-DMFfBHET.js";
import { B as Button } from "./button-BH__aUd2.js";
import "./PlanBadge-C1k5hm80.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-CwUeXz8q.js";
...
import { P as Progress } from "./progress-B-y_IDKj.js";
...
import { a as MOCK_API_KEYS, b as MOCK_WEBHOOKS } from "./billingMockData-DQD-9K-v.js";
import { u as useSubscription } from "./useFeature-Bsm8IpgN.js";
import { u as ue } from "./index-wIYsNRKm.js";
import { W as Webhook } from "./webhook-DkWsvqNS.js";
...
import { A as ArrowRight } from "./arrow-right-DfkiJdnu.js";
import { C as CircleCheck } from "./circle-check-k6E8EYPA.js";
import "./lock-keyhole-Dovi7B6L.js";
import "./diamond-D6PDW6H8.js";
...
const INTEGRATIONS = [
  ...
  // Monitoring
  {
    ...
    description: "Open-source enterprise network monitoring and alerting platform."
  },
  {
    id: "prometheus",
    name: "Prometheus",
...
function IntegrationCard({ integration }) {
  ...
  const [zabbixConn, setZabbixConn] = reactExports.useState({
    connected: integration.id === "zabbix" && integration.status === "connected",
    hostCount: 0,
    activeAlerts: 0
  });
  const isZabbix = integration.id === "zabbix";
  const effectiveConnected = isZabbix ? zabbixConn.connected : connected;
  function handleZabbixConnectionChange(state) {
    setZabbixConn(state);
    if (state.connected) {
      ue.success("Zabbix connected");
    }
  }
  const zabbixServerShort = "zabbix.fibernms.internal";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-4 pb-4 space-y-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative shrink-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    className: cn(
                      "size-10 rounded-lg flex items-center justify-center text-sm font-bold font-mono",
                      integration.iconBg
                    ),
                    children: integration.icon
                  }
                ),
                isZabbix && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: cn(
                      "absolute -bottom-0.5 -right-0.5 size-2.5 rounded-full border-2 border-card",
                      effectiveConnected ? "bg-emerald-400" : "bg-muted-foreground/40"
                    ),
                    "aria-label": effectiveConnected ? "Zabbix connected" : "Zabbix not connected"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: integration.name }),
                isZabbix ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: effectiveConnected ? `Connected to ${zabbixServerShort}` : "Not configured" }) : effectiveConnected && integration.lastSync && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                  "Synced ",
                  formatRelativeTime(integration.lastSync)
                ] }),
                isZabbix && effectiveConnected && zabbixConn.lastSync && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                  "Synced ",
                  formatRelativeTime(zabbixConn.lastSync)
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              StatusBadge,
              {
                status: effectiveConnected ? "connected" : "not_connected"
              }
            )
          ] }),
          ...
          isZabbix && effectiveConnected && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 rounded-lg border border-red-500/20 bg-red-500/5 px-3 py-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: zabbixConn.hostCount }),
              " ",
              "hosts"
            ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: cn(
                    "font-medium",
                    zabbixConn.activeAlerts > 0 ? "text-rose-400" : "text-foreground"
                  ),
                  children: zabbixConn.activeAlerts
                }
              ),
              " ",
              "active alerts"
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 pt-1 flex-wrap", children: isZabbix ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                variant: "outline",
                ...
                "data-ocid": "integration-configure-zabbix",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { className: "size-3" }),
                  effectiveConnected ? "Configure" : "Connect"
                ]
              }
            ),
            effectiveConnected && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Link,
                {
                  to: "/integrations/zabbix",
                  className: "bg-cyan-500/20 text-cyan-400 border border-cyan-500/30 hover:bg-cyan-500/30 rounded-lg px-3 py-1.5 text-xs font-medium flex items-center gap-1.5 transition-colors h-7",
                  "data-ocid": "integration-zabbix-dashboard-link",
                  children: [
                    "Open Dashboard",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  variant: "ghost",
                  size: "sm",
                  className: "text-muted-foreground hover:bg-muted/50 h-7 text-xs gap-1.5",
                  onClick: () => {
                    setZabbixConn((s) => ({ ...s, lastSync: Date.now() }));
                    ue.success("Zabbix sync triggered");
                  },
                  "data-ocid": "integration-zabbix-sync-now",
                  children: [
          ...
          !isZabbix && configOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 border-t border-border space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
    ...
    isZabbix && /* @__PURE__ */ jsxRuntimeExports.jsx(
      ZabbixConfigSheet,
      {
        ...
        connectionState: zabbixConn,
        onConnectionChange: (state) => {
          handleZabbixConnectionChange(state);
          if (!state.connected) setConfigOpen(false);
        }
      }
    )
  ] });
