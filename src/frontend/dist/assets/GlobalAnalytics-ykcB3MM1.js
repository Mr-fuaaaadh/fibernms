import { r as reactExports, at as Building2, a0 as Server, a8 as Zap, j as jsxRuntimeExports, m as motion, a6 as ChartColumn, a7 as TrendingUp, a3 as Badge } from "./index-RpWpgnOS.js";
...
import { D as DollarSign } from "./dollar-sign-DVMoPXIC.js";
import { T as TrendingDown } from "./trending-down-CKI-1F1S.js";
import { R as ResponsiveContainer, T as Tooltip, B as Bar, C as Cell, L as Legend } from "./generateCategoricalChart-DaWA7quf.js";
import { B as BarChart } from "./BarChart-Dn__P_OM.js";
import { C as CartesianGrid } from "./CartesianGrid-B45vMZnW.js";
import { X as XAxis, Y as YAxis } from "./YAxis-eOBncTvm.js";
import { L as LineChart } from "./LineChart-B-IMxHLl.js";
import { L as Line } from "./Line-BL_hd6tF.js";
import { P as PieChart, a as Pie } from "./PieChart-C1DREYaW.js";
import "./PolarAngleAxis-CmHLv9LK.js";
const DATE_RANGES = [
  "Last 30 Days",
  "Last 60 Days",
  "Last 90 Days",
...
function GlobalAnalytics() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-8 max-w-[1600px]", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { className: "p-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 240, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: topCustomers, layout: "vertical", barSize: 14, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CartesianGrid,
          {
            strokeDasharray: "3 3",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { className: "p-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: deviceGrowthData, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CartesianGrid,
          {
            strokeDasharray: "3 3",
        ...
        ["BASIC", "PROFESSIONAL", "ENTERPRISE", "ULTRA"].map((plan) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Line,
          {
            type: "monotone",
            dataKey: plan,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { className: "p-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: alertStackData, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CartesianGrid,
          {
            strokeDasharray: "3 3",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { className: "p-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: regionalData, barSize: 40, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            CartesianGrid,
            {
              strokeDasharray: "3 3",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { className: "p-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: revenueTrendData, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CartesianGrid,
          {
            strokeDasharray: "3 3",
