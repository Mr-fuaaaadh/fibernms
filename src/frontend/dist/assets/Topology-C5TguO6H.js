import { c as createLucideIcon, u as useNetworkStore, r as reactExports, j as jsxRuntimeExports, m as motion, N as Network, G as GitFork, A as AnimatePresence, X, T as TriangleAlert, f as Activity, h as Cpu, M as MapPin, i as GitBranch, k as Radio, b as cn } from "./index-CZ0VXYC-.js";
import { G as GlassCard } from "./GlassCard-Dl46dwD3.js";
import { B as Box, R as Router, D as DeviceIcon, S as StatusBadge } from "./StatusBadge-Y-8dJ6ki.js";
import { W as Wifi } from "./wifi-C9evVs35.js";
import { C as CircleCheck } from "./circle-check-Mgf9PDUH.js";
import { C as CircleX } from "./circle-x-Pjwfriil.js";
...
function LayerToggleBar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", "data-ocid": "layer-toggle-toolbar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mr-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { className: "w-3.5 h-3.5 text-muted-foreground" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-display tracking-widest text-muted-foreground uppercase", children: "Layers" })
    ] }),
    LAYER_CONFIGS.map((cfg) => {
      const layer = networkLayers.find((l) => l.type === cfg.type);
      const isVisible = (layer == null ? void 0 : layer.visible) ?? false;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          className: cn(
            ...
            isVisible ? cfg.activeClass : "text-muted-foreground/50 border-border/30 hover:border-border/60 hover:text-muted-foreground"
          ),
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
...
function LayerLegend() {
  ...
  const visibleLayers = LAYER_CONFIGS.filter(
    (cfg) => {
      var _a;
      return (_a = networkLayers.find((l) => l.type === cfg.type)) == null ? void 0 : _a.visible;
    }
  );
  if (visibleLayers.length === 0) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-4 left-4 z-10 flex flex-col gap-1.5 glass-card rounded-xl px-3 py-2.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-display tracking-widest text-muted-foreground/60 uppercase mb-1", children: "Active Layers" }),
    visibleLayers.map((cfg) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      cfg.type === "L1" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
      ...
      ) : cfg.type === "L2" ? /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: 20, height: 4, "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "line",
        {
          x1: 0,
          y1: 2,
      ...
      ) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: 20, height: 4, "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "line",
        {
          x1: 0,
          y1: 2,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono text-muted-foreground", children: cfg.sublabel })
    ] }, cfg.type))
  ] });
}
function Topology() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between gap-3 flex-wrap", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LayerToggleBar, {}) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            GlassCard,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { height: "calc(100% - 44px)" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TopologyGraph, {}),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(LayerLegend, {})
                ] })
              ]
            }
          ),
