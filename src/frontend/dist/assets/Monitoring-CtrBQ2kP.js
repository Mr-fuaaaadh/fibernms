import { c as createLucideIcon, i as isEasingArray, h as interpolate$1, V as VisualElement, k as createBox, l as useConstant, n as motionValue, r as reactExports, M as MotionConfigContext, p as useIsomorphicLayoutEffect, q as cancelFrame, s as frame, t as collectMotionValues, v as resolveElements, w as mixNumber, x as removeItem, y as isMotionValue, z as defaultOffset, B as createGeneratorEasing, D as fillOffset, E as isGenerator, F as secondsToMilliseconds, H as progress, I as isSVGElement, J as isSVGSVGElement, S as SVGVisualElement, K as HTMLVisualElement, L as visualElementStore, N as animateSingleValue, O as animateTarget, P as spring, j as jsxRuntimeExports, A as AnimatePresence, m as motion, T as TriangleAlert, a as commonjsGlobal, g as getDefaultExportFromCjs, Q as clsx, o, U as invariant, d as useNavigate, u as useNetworkStore, W as mockDevices, Y as Server, R as Radio, Z as mockAlerts } from "./index-BwSs_aWH.js";
import { C as CircleX } from "./circle-x-CiTK5a2S.js";
import { C as Clock } from "./clock-B7qHusXe.js";
...
const MonitorDot = createLucideIcon("monitor-dot", __iconNode$1);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function useTransform(input, inputRangeOrTransformer, outputRangeOrMap, options) {
  ...
  const result = Array.isArray(input) ? useListTransform(input, transformer2) : useListTransform([input], ([latest]) => transformer2(latest));
...
const isNumber$4 = (keyframe) => typeof keyframe === "number";
const isNumberKeyframesArray = (keyframes) => keyframes.every(isNumber$4);
...
function formatTs(ts) {
  return format$1(new Date(ts), "MMM dd HH:mm");
}
function AlertsPanel({ alerts, onAlertClick }) {
  const active = alerts.filter((a2) => !a2.resolved);
...
function Surface(props) {
  ...
  return /* @__PURE__ */ o.createElement("svg", _extends$u({}, filterProps(others, true, "svg"), {
...
var Layer = /* @__PURE__ */ o.forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ o.createElement("g", _extends$t({
    className: layerClass
...
var Symbols = function Symbols2(_ref) {
  ...
  if (cx === +cx && cy === +cy && size === +size) {
    return /* @__PURE__ */ o.createElement("path", _extends$s({}, filteredProps, {
...
function _getPrototypeOf$i(o2) {
  _getPrototypeOf$i = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf2(o3) {
...
function _setPrototypeOf$i(o2, p2) {
  _setPrototypeOf$i = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf2(o3, p3) {
    o3.__proto__ = p3;
    return o3;
  };
  ...
  return _createClass$l(DefaultLegendContent2, [{
    ...
    value: function renderItems() {
      ...
      return payload.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement("li", _extends$r({
          className,
          style: itemStyle,
...
var DefaultTooltipContent = function DefaultTooltipContent2(props) {
  ...
  return /* @__PURE__ */ o.createElement("div", _extends$q({
    className: wrapperCN,
    style: finalStyle
...
var Text = function Text2(_ref5) {
  ...
  return /* @__PURE__ */ o.createElement("text", _extends$p({}, filterProps(textProps, true), {
    x: x2,
    y: y2,
...
function transformer$2() {
  var domain = unit, range3 = unit, interpolate$12 = interpolate, transform2, untransform, unknown, clamp = identity$6, piecewise2, output, input;
  function rescale() {
  ...
  function scale(x2) {
    return x2 == null || isNaN(x2 = +x2) ? unknown : (output || (output = piecewise2(domain.map(transform2), range3, interpolate$12)))(transform2(clamp(x2)));
  }
  scale.invert = function(y2) {
    return clamp(untransform((input || (input = piecewise2(range3, domain.map(transform2), interpolateNumber$1)))(y2)));
  };
  scale.domain = function(_) {
  ...
  scale.rangeRound = function(_) {
    return range3 = Array.from(_), interpolate$12 = interpolateRound, rescale();
  };
...
function transformer$1() {
  var x0 = 0, x1 = 1, t02, t12, k10, transform2, interpolator = identity$6, clamp = false, unknown;
  function scale(x2) {
...
function transformer() {
  var x0 = 0, x1 = 0.5, x2 = 1, s2 = 1, t02, t12, t2, k10, k21, interpolator = identity$6, transform2, clamp = false, unknown;
  function scale(x3) {
  ...
  scale.domain = function(_) {
    return arguments.length ? ([x0, x1, x2] = _, t02 = transform2(x0 = +x0), t12 = transform2(x1 = +x1), t2 = transform2(x2 = +x2), k10 = t02 === t12 ? 0 : 0.5 / (t12 - t02), k21 = t12 === t2 ? 0 : 0.5 / (t2 - t12), s2 = t12 < t02 ? -1 : 1, scale) : [x0, x1, x2];
  };
  scale.clamp = function(_) {
    return arguments.length ? (clamp = !!_, scale) : clamp;
  };
...
function _getPrototypeOf$e(o2) {
  _getPrototypeOf$e = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf2(o22) {
...
function _setPrototypeOf$e(o2, p2) {
  _setPrototypeOf$e = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf2(o22, p22) {
    o22.__proto__ = p22;
    return o22;
  };
...
var renderRadialLabel = function renderRadialLabel2(labelProps, label, attrs) {
  ...
  return /* @__PURE__ */ o.createElement("text", _extends$n({}, attrs, {
...
function Label(_ref4) {
  ...
  return /* @__PURE__ */ o.createElement(Text, _extends$n({
...
var parseLabel = function parseLabel2(label, viewBox) {
  ...
  if (isObject$8(label)) {
    return /* @__PURE__ */ o.createElement(Label, _extends$n({
      viewBox
    }, label, {
      key: "label-implicit"
    }));
...
function LabelList(_ref) {
  ...
  return /* @__PURE__ */ o.createElement(Layer, {
    ...
    return /* @__PURE__ */ o.createElement(Label, _extends$m({}, filterProps(entry, true), others, idProps, {
...
function parseLabelList(label, data) {
  ...
  if (isObject$8(label)) {
    return /* @__PURE__ */ o.createElement(LabelList, _extends$m({
      data
    }, label, {
      key: "labelList-implicit"
    }));
...
var Sector = function Sector2(sectorProps) {
  ...
  return /* @__PURE__ */ o.createElement("path", _extends$l({}, filterProps(props, true), {
    className: layerClass,
    d: path,
    role: "img"
  }));
...
var Rectangle = function Rectangle2(rectangleProps) {
  ...
  return /* @__PURE__ */ o.createElement(Animate, {
    ...
    }, /* @__PURE__ */ o.createElement("path", _extends$j({}, filterProps(props, true), {
      className: layerClass,
...
var Polygon = function Polygon2(props) {
  ...
  if (baseLinePoints && baseLinePoints.length) {
    ...
    return /* @__PURE__ */ o.createElement("g", {
      className: layerClass
    }, /* @__PURE__ */ o.createElement("path", _extends$i({}, filterProps(others, true), {
      fill: rangePath.slice(-1) === "Z" ? others.fill : "none",
      stroke: "none",
      d: rangePath
    })), hasStroke ? /* @__PURE__ */ o.createElement("path", _extends$i({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(points, connectNulls)
    })) : null, hasStroke ? /* @__PURE__ */ o.createElement("path", _extends$i({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(baseLinePoints, connectNulls)
    })) : null);
  }
  var singlePath = getSinglePolygonPath(points, connectNulls);
  return /* @__PURE__ */ o.createElement("path", _extends$i({}, filterProps(others, true), {
...
var PolarRadiusAxis = /* @__PURE__ */ function(_PureComponent) {
  ...
  return _createClass$e(PolarRadiusAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      return /* @__PURE__ */ o.createElement("line", _extends$f({
    ...
    value: function renderTicks() {
      ...
      var items = ticks2.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement(Layer, _extends$f({
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ o.isValidElement(option)) {
        ...
        tickItem = /* @__PURE__ */ o.createElement(Text, _extends$f({}, props, {
  ...
  return _createClass$d(PolarAngleAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      if (axisLineType === "circle") {
        return /* @__PURE__ */ o.createElement(Dot, _extends$e({
      ...
      return /* @__PURE__ */ o.createElement(Polygon, _extends$e({
        className: "recharts-polar-angle-axis-line"
      }, props, {
        points
      }));
    ...
    value: function renderTicks() {
      ...
      var items = ticks2.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement(Layer, _extends$e({
          ...
          key: "tick-".concat(entry.coordinate)
        }, adaptEventsOfChild(_this.props, entry, i)), tickLine && /* @__PURE__ */ o.createElement("line", _extends$e({
...
var Trapezoid = function Trapezoid2(props) {
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ o.createElement("g", null, /* @__PURE__ */ o.createElement("path", _extends$d({}, filterProps(trapezoidProps, true), {
      className: layerClass,
  ...
  return /* @__PURE__ */ o.createElement(Animate, {
    ...
    return /* @__PURE__ */ o.createElement(Animate, {
      ...
      duration: animationDuration,
      easing: animationEasing
    }, /* @__PURE__ */ o.createElement("path", _extends$d({}, filterProps(trapezoidProps, true), {
      className: layerClass,
  ...
  return _createClass$c(Pie2, [{
    ...
    value: function renderSectorsStatically(sectors) {
      ...
      return sectors.map(function(entry, i) {
        ...
        }), /* @__PURE__ */ o.createElement(Shape, _extends$c({
    ...
    value: function renderLabelLineItem(option, props, key) {
      ...
      return /* @__PURE__ */ o.createElement(Curve, _extends$c({}, props, {
        key,
        type: "linear",
        className
      }));
    ...
    value: function renderLabelItem(option, props, value) {
      ...
      return /* @__PURE__ */ o.createElement(Text, _extends$c({}, props, {
...
const CustomTooltip$1 = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-elevated rounded-xl p-3 text-xs border border-border/50 shadow-xl", children: [
    ...
    payload.map((p2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono font-semibold", style: { color: p2.color }, children: [
        p2.value,
        " dBm"
      ] })
    ] }, p2.name))
...
function AnimatedCounter({
  ...
  const display = useTransform(motionVal, (v2) => Math.round(v2).toString());
    ...
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2", children: [
          ...
          unit2 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-sm mb-1", children: unit2 })
        ] }),
...
function buildSignalHistory() {
  ...
  return Array.from({ length: 24 }, (_, i) => {
    const h2 = i.toString().padStart(2, "0");
    const point2 = { time: `${h2}:00` };
    for (let idx = 0; idx < NAMES.length; idx++) {
      point2[NAMES[idx]] = +(BASE_SIGNALS[idx] + (Math.random() * 4 - 2)).toFixed(1);
    }
    return point2;
  });
}
function addSignalNoise(data, oltNames) {
  return data.map((point2) => {
    const next = { time: point2.time };
    for (const name of oltNames) {
      const prev = point2[name];
...
function Monitoring() {
  ...
  const baseOnline = mockDevices.filter((d2) => d2.status === "active").length;
  const baseOffline = mockDevices.filter((d2) => d2.status === "faulty").length;
  const baseWarning = mockDevices.filter((d2) => d2.status === "warning").length;
  const baseOlts = mockDevices.filter((d2) => d2.type === "OLT").length;
  const baseOnts = mockDevices.filter((d2) => d2.type === "ONT").length;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-6", "data-ocid": "monitoring-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-52", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SignalLineChart, { data: signalData, oltNames: OLT_NAMES }) })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
