import { u as useNetworkStore, r as reactExports, j as jsxRuntimeExports, ai as Shield, e as cn, T as TriangleAlert, m as motion, q as Activity, h as Clock } from "./index-DzTbe00m.js";
...
import { R as ResponsiveContainer, T as Tooltip, L as Legend } from "./generateCategoricalChart-CRjuZGyA.js";
...
function SLATrendChart({ timeRange }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { elevated: true, className: "p-5 h-full", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-[500px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      LineChart,
      {
        data,
