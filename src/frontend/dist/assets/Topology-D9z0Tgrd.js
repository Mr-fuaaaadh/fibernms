import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, m as motion, T as TriangleAlert, q as ChevronRight, s as Activity, G as GitBranch, k as useIsMobile, u as useNetworkStore, N as Network, t as GitFork, A as AnimatePresence, M as MapPin, X, v as Cpu, w as ChartColumn, Z as Zap, x as Radio } from "./index-CBnSp17V.js";
...
import { C as CircleMinus, a as CirclePlus } from "./circle-plus-DPUKupu4.js";
import { G as Globe } from "./globe-DjGmycuv.js";
import { L as Link2 } from "./link-2-L4yMisBH.js";
import { B as Box, D as DeviceIcon } from "./DeviceIcon-DN3EkBFB.js";
import { M as Monitor } from "./monitor-52Q67PUW.js";
import { C as CircleX } from "./circle-x-BbQYu4X3.js";
import { R as RefreshCw } from "./refresh-cw-DjODROuH.js";
import { E as Earth } from "./earth-8kD7vydU.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 sm:px-4 pt-3 sm:pt-4 pb-2 sm:pb-3 flex items-start justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 sm:gap-3 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Router, { style: { color: "#06b6d4", width: 16, height: 16 } })
              }
            ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 sm:px-4 pb-2 sm:pb-3 flex items-center justify-between gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-2 sm:px-3 pb-3 sm:pb-4 grid grid-cols-3 gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatPill,
            {
              icon: GitBranch,
...
function assignPositions(roots, isMobile) {
...
function TopologyNode({
  ...
  const fontSize = compact ? isOLT ? 9 : isSplitter ? 8 : 7 : isOLT ? 11 : isSplitter ? 10 : 9;
  const truncName = device.name.length > 10 ? `${device.name.slice(0, 10)}…` : device.name;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.g,
    {
      ...
      children: [
        ...
        isOLT && !compact && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "text",
          {
            x,
            y: labelY + 12,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "circle",
          {
            ...
            onMouseEnter: (e) => {
              ...
              pt.x = e.clientX;
              pt.y = e.clientY;
              const sp = pt.matrixTransform((_a = svgEl.getScreenCTM()) == null ? void 0 : _a.inverse());
...
function TopologyEdge({ from, to, index, animated = true }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
    ...
    animated && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { id: `edge-path-${index}`, d }) })
    ] })
  ] });
}
function Minimap({ allNodes, totalW, totalH, small }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        !small && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-2 py-1 border-b border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-mono text-white/30 uppercase tracking-widest", children: "Minimap" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            width: W,
              ...
              allNodes.map((n) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "circle",
                  {
                    cx: n.x * scaleX,
                    cy: n.y * scaleY,
                    r: n.device.type === "OLT" ? 3 : n.device.type === "Splitter" ? 2 : 1.5,
                    fill: mainColor,
                    opacity: 0.8,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        isMobile && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2 left-1/2 -translate-x-1/2 z-20 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `absolute z-20 flex items-center gap-1 px-2 py-1.5 rounded-xl ${isMobile ? "bottom-4 right-4" : "top-4 right-4"}`,
            style: {
              background: "rgba(2,8,23,0.85)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              ...
              minHeight: isMobile ? "400px" : void 0
            },
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono text-white/40 uppercase tracking-widest truncate mr-2", children: label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: "text-xs font-mono font-bold flex-shrink-0",
              style: { color },
              children: values[values.length - 1]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
...
function EmptyState() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-20 h-20 sm:w-24 sm:h-24", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      style: {
        ...
        backdropFilter: "blur(12px)",
        width: isMobileSheet ? void 0 : isMobile ? "100%" : 340
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: device ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(DevicePanel, { device, compact })
        },
        device.id
...
function StatCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      className: `relative flex flex-col gap-1 rounded-xl border border-white/10 bg-white/5 backdrop-blur-md overflow-hidden ${compact ? "px-3 py-2" : "px-4 py-3"}`,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-0.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono uppercase tracking-widest text-white/40 truncate", children: label })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
...
function LayerToggle({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      type: "button",
      className: `flex items-center gap-2 rounded-xl border transition-all duration-300 cursor-pointer select-none flex-shrink-0 ${compact ? "px-2.5 py-1.5" : "px-4 py-3"} ${isOn ? `${cfg.bgClass} ${cfg.borderClass}` : "bg-white/5 border-white/10"}`,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: `font-semibold font-mono transition-colors whitespace-nowrap ${compact ? "text-[10px]" : "text-xs"} ${isOn ? cfg.textClass : "text-white/40"}`,
            children: cfg.label
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            children: healthy ? "Healthy" : `${faultyCount} Fault${faultyCount > 1 ? "s" : ""}`
          }
        )
      ]
    }
...
function OLTSummaryBar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 overflow-x-auto scrollbar-none", children: items.map((item) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-3 h-3", style: { color: item.color } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: "text-[10px] font-mono",
...
function Topology() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-shrink-0 px-3 sm:px-6 pt-3 md:pt-5 pb-2 md:pb-4 border-b border-white/8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2 mb-2 md:mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 sm:gap-4 min-w-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-0.5 flex-wrap", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] font-mono text-white/40 truncate", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-[10px] font-mono text-white/30", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "w-2.5 h-2.5 flex-shrink-0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "whitespace-nowrap", children: syncLabel })
                  ] })
                ] })
              ] })
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 sm:grid-cols-3 md:grid-cols-6 gap-2", children: statCards.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
            {
              ...s,
              delay: i * 0.06,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 px-3 sm:px-6 py-2 border-b border-white/8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 flex-shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "w-3 h-3 text-white/30" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono uppercase tracking-widest text-white/30 hidden sm:block", children: "Layers" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 overflow-x-auto scrollbar-none flex-1 pb-0.5", children: LAYER_CONFIGS.map((cfg) => /* @__PURE__ */ jsxRuntimeExports.jsx(LayerToggle, { cfg, compact: isMobile }, cfg.type)) })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 min-h-0 relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: viewMode === "sections" ? (
              ...
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: `flex-1 overflow-y-auto px-3 sm:px-6 py-3 sm:py-5 ${isMobile ? "pb-24" : "pb-4"}`,
                      style: { scrollbarColor: "rgba(6,182,212,0.2) transparent" },
                      ...
                      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3 sm:gap-4", children: filteredOlts.map((olt, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        OLTSectionCard,
                        {
                          olt,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 relative overflow-hidden flex flex-col min-h-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono text-white/40 uppercase tracking-widest", children: "Live Topology" })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-h-0 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TopologyGraph, {}) })
                  ] }),
          ...
          viewMode === "sections" && selectedDevice && !isMobile && /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 sm:px-6 py-2 overflow-x-auto scrollbar-none", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Earth, { className: "w-3.5 h-3.5 text-white/30 flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1.5 flex-nowrap", children: REGIONS.map((region) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 ml-auto flex-shrink-0", children: [
                unresolvedAlerts > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-red-500/10 border border-red-500/20", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-mono text-red-400 whitespace-nowrap", children: [
                    unresolvedAlerts,
                    " Alerts"
                  ] })
                ] }),
                warnCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-yellow-500/10 border border-yellow-500/20", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-3 h-3 text-yellow-400" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-mono text-yellow-400 whitespace-nowrap", children: [
                    warnCount,
                    " Warn"
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Export SVG" })
                    ]
                  }
                )
              ] })
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(TopologyNodePanel, { device: selectedDevice, isMobileSheet: true })
                  }
                )
              ]
            },
