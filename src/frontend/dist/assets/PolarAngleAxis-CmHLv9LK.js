import { ah as clsx, o, g as getDefaultExportFromCjs, r as reactExports } from "./index-RpWpgnOS.js";
import { f as filterProps, a1 as _baseExtremum, a2 as _baseGt, a3 as _baseIteratee, a4 as _baseLt, i as isFunction, V as Text, p as polarToCartesian, b as Layer, a5 as getTickClassName, k as adaptEventsOfChild, Y as Label, D as Dot } from "./generateCategoricalChart-DaWA7quf.js";
...
var Polygon = function Polygon2(props) {
  ...
  if (baseLinePoints && baseLinePoints.length) {
    ...
    }, /* @__PURE__ */ o.createElement("path", _extends$2({}, filterProps(others, true), {
      fill: rangePath.slice(-1) === "Z" ? others.fill : "none",
      stroke: "none",
      d: rangePath
    })), hasStroke ? /* @__PURE__ */ o.createElement("path", _extends$2({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(points, connectNulls)
    })) : null, hasStroke ? /* @__PURE__ */ o.createElement("path", _extends$2({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(baseLinePoints, connectNulls)
    })) : null);
  }
  var singlePath = getSinglePolygonPath(points, connectNulls);
  return /* @__PURE__ */ o.createElement("path", _extends$2({}, filterProps(others, true), {
...
var PolarRadiusAxis = /* @__PURE__ */ function(_PureComponent) {
  ...
  return _createClass$1(PolarRadiusAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      return /* @__PURE__ */ o.createElement("line", _extends$1({
  ...
  return _createClass(PolarAngleAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      if (axisLineType === "circle") {
        return /* @__PURE__ */ o.createElement(Dot, _extends({
      ...
      return /* @__PURE__ */ o.createElement(Polygon, _extends({
        className: "recharts-polar-angle-axis-line"
      }, props, {
        points
      }));
    ...
    value: function renderTicks() {
      ...
      var items = ticks.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement(Layer, _extends({
          ...
          key: "tick-".concat(entry.coordinate)
        }, adaptEventsOfChild(_this.props, entry, i)), tickLine && /* @__PURE__ */ o.createElement("line", _extends({
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ o.isValidElement(option)) {
        ...
        tickItem = /* @__PURE__ */ o.createElement(Text, _extends({}, props, {
