import { c as createLucideIcon, u as useNetworkStore, r as reactExports, s as CircleAlert, aj as Shield, ah as TrendingUp, j as jsxRuntimeExports, ak as Bot, d as Activity, T as TriangleAlert, ae as Badge, m as motion, A as AnimatePresence, al as Map, ai as Zap, X, q as ChevronRight, am as User } from "./index-BhX-NLFL.js";
import { G as GlassCard } from "./GlassCard-C7Gd1A09.js";
...
import { P as Plus } from "./plus-BWZd431X.js";
import { C as Check } from "./check-gNBXC45_.js";
import { C as Copy } from "./copy-CWxaP8sE.js";
import { E as ExternalLink } from "./external-link-Brjs84PW.js";
/**
...
const DEFAULT_ACTION_CARDS = [
  ...
  { label: "Run Diagnostic", icon: Zap, query: "Diagnose network health" }
];
...
function AIMessage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-primary/20 border border-primary/30 flex items-center justify-center flex-shrink-0 mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { size: 13, className: "text-primary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(GlassCard, { className: "px-3 py-2.5 sm:px-4 sm:py-3 rounded-2xl rounded-tl-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-foreground/90 leading-relaxed space-y-0.5", children: renderMarkdown(msg.content) }) }),
...
function UserMessage({ msg }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[85%] sm:max-w-[75%] min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary/20 border border-primary/30 rounded-2xl rounded-tr-sm px-3 py-2.5 sm:px-4 sm:py-3 text-sm text-foreground leading-relaxed", children: msg.content }),
...
function NetworkContextContent({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full overflow-y-auto noc-scrollbar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 border-b border-border/30 flex items-center justify-between flex-shrink-0", children: [
...
function SessionSidebarContent({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full bg-card/40", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-b border-border/30 flex items-center justify-between flex-shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto noc-scrollbar p-2 space-y-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { initial: false, children: sessions.map((session, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.button,
        {
          ...
          className: `w-full text-left px-3 py-2.5 rounded-xl transition-smooth group min-h-[56px] ${activeId === session.id ? "bg-primary/15 border border-primary/30 noc-glow" : "hover:bg-muted/40 border border-transparent"}`,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 border-t border-border/30 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-2 py-1.5", children: [
...
function AIAssistant() {
  ...
  const [sessionDrawerOpen, setSessionDrawerOpen] = reactExports.useState(false);
  const [contextDrawerOpen, setContextDrawerOpen] = reactExports.useState(false);
...
Ask me anything about the current network state.`,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:flex w-64 flex-shrink-0 border-r border-border/30 h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 min-w-0 h-full overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-3 sm:px-5 py-3 sm:py-3.5 border-b border-border/30 bg-card/30 flex-shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 sm:gap-3 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1 lg:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  onClick: () => {
                  ...
                  children: [
                    ...
                    sessions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-1.5 right-1.5 w-1.5 h-1.5 rounded-full bg-primary" })
                  ]
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-primary/15 border border-primary/30 flex items-center justify-center noc-glow flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { size: 16, className: "text-primary" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-xs sm:text-sm font-semibold text-foreground tracking-wide truncate", children: "Network AI Assistant" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] sm:text-[10px] text-muted-foreground truncate", children: "Powered by FiberNMS Intelligence" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 sm:gap-4 flex-shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-3 text-[10px] text-muted-foreground", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "hidden lg:flex items-center gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Wifi, { size: 10, className: "text-emerald-400" }),
                  onlineDevices.length,
                  " online"
                ] }),
                faultyDevices.length + warnDevices.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "hidden lg:flex items-center gap-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Badge,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Online" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    activeAlerts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-1.5 right-1.5 w-1.5 h-1.5 rounded-full bg-destructive" })
                  ]
                }
              )
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-h-0 overflow-y-auto px-3 py-3 sm:p-5 noc-scrollbar", children: [
            isEmpty && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-primary/10 border border-primary/20 flex items-center justify-center mb-4 noc-glow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { size: 24, className: "text-primary" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-sm sm:text-base font-semibold text-foreground mb-1", children: "Ask FiberNMS AI" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs sm:text-sm text-muted-foreground mb-5 sm:mb-6 max-w-xs sm:max-w-sm px-2", children: "Get instant insights on network faults, SLA compliance, predictive risks, signal quality, and topology analysis." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 justify-center max-w-xs sm:max-w-lg px-2", children: SUGGESTED.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
          ...
          !isEmpty && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 sm:px-5 pt-1.5 sm:pt-2 pb-1 flex flex-wrap gap-1 sm:gap-1.5 border-t border-border/20 overflow-x-auto", children: SUGGESTED.slice(0, 4).map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => sendMessage(s.query),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-3 sm:px-5 sm:py-4 border-t border-border/30 flex gap-2 items-end bg-card/20 flex-shrink-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(NetworkContextContent, { onItemClick: sendMessage })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: sessionDrawerOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DrawerBackdrop, { onClose: () => setSessionDrawerOpen(false) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              initial: { x: "-100%" },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: contextDrawerOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DrawerBackdrop, { onClose: () => setContextDrawerOpen(false) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              initial: { x: "100%" },
