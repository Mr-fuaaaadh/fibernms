...
export const mockDevices: Device[] = (() => {
  ...
  // ── London seed devices — visible at initial map center/zoom ─────────────
  const LONDON_DEVICES: Device[] = [
    {
      id: "olt-london-1",
      name: "OLT-LON-CORE-01",
      type: "OLT",
      lat: 51.515,
      lng: -0.142,
      ports: 32,
      status: "active",
      connectedTo: ["spl-london-1", "spl-london-2"],
      location: "Paddington Exchange, London",
      signalStrength: -16.5,
      uptime: 99.82,
      region: "Europe",
    },
    {
      id: "olt-london-2",
      name: "OLT-LON-EAST-01",
      type: "OLT",
      lat: 51.518,
      lng: -0.056,
      ports: 16,
      status: "active",
      connectedTo: ["spl-london-3"],
      location: "Whitechapel Exchange, London",
      signalStrength: -17.2,
      uptime: 99.71,
      region: "Europe",
    },
    {
      id: "spl-london-1",
      name: "SPL-LON-CITY-01",
      type: "Splitter",
      lat: 51.512,
      lng: -0.09,
      ports: 8,
      status: "active",
      connectedTo: ["olt-london-1"],
      location: "City of London DP-01",
      signalStrength: -24.1,
      uptime: 99.5,
      region: "Europe",
    },
    ...
    {
      id: "spl-london-3",
      name: "SPL-LON-CANARY-01",
      type: "Splitter",
      lat: 51.508,
      lng: -0.022,
      ports: 16,
      status: "active",
      connectedTo: ["olt-london-2"],
      location: "Canary Wharf DP-01",
      signalStrength: -23.8,
      uptime: 99.6,
      region: "Europe",
    },
    {
      ...
      status: "active",
      connectedTo: [],
      location: "Holborn Core POP, London",
      signalStrength: -14.2,
      uptime: 99.95,
      region: "Europe",
    },
  ];
  devices.push(...LONDON_DEVICES);

  return devices;
})();

// ─── Fiber Routes ─────────────────────────────────────────────────────────────
// Pre-seeded London routes ensure fiber polylines are immediately visible on
// map load (center [51.505, -0.09], zoom 11).
const LONDON_SEED_ROUTES: FiberRoute[] = [
  {
    id: "route-london-bb-1",
    name: "BACKBONE-LON-CORE",
    type: "backbone",
    status: "active",
    distanceKm: 12.4,
    waypoints: [
      { lat: 51.515, lng: -0.142 }, // Paddington
      { lat: 51.512, lng: -0.09 }, // City of London
      { lat: 51.505, lng: -0.065 }, // Bermondsey
      { lat: 51.496, lng: -0.06 }, // Deptford
    ],
  },
  {
    id: "route-london-bb-2",
    name: "BACKBONE-LON-NORTH",
    type: "backbone",
    status: "active",
    distanceKm: 9.8,
    waypoints: [
      { lat: 51.54, lng: -0.17 }, // Hammersmith
      { lat: 51.53, lng: -0.12 }, // Kensington
      { lat: 51.522, lng: -0.087 }, // Holborn
      { lat: 51.518, lng: -0.056 }, // Whitechapel
    ],
  },
  {
    id: "route-london-dist-1",
    name: "DISTRIBUTION-LON-SW",
    type: "distribution",
    status: "active",
    distanceKm: 5.2,
    waypoints: [
      { lat: 51.497, lng: -0.134 }, // Battersea
      { lat: 51.493, lng: -0.116 }, // Clapham
      { lat: 51.488, lng: -0.098 }, // Stockwell
    ],
  },
  {
    id: "route-london-dist-2",
    name: "DISTRIBUTION-LON-E",
    type: "distribution",
    status: "warning",
    distanceKm: 6.7,
    waypoints: [
      { lat: 51.508, lng: -0.022 }, // Canary Wharf area
      { lat: 51.512, lng: 0.003 }, // Poplar
      { lat: 51.518, lng: 0.016 }, // Stratford approach
    ],
  },
  {
    id: "route-london-drop-1",
    name: "DROP-LON-CAMDEN",
    type: "drop",
    status: "active",
    distanceKm: 2.1,
    waypoints: [
      { lat: 51.538, lng: -0.143 }, // Camden Town
      { lat: 51.535, lng: -0.138 },
      { lat: 51.531, lng: -0.133 }, // Kentish Town
    ],
  },
  {
    id: "route-london-drop-2",
    name: "DROP-LON-SOUTHBANK",
    type: "drop",
    status: "active",
    distanceKm: 3.0,
    waypoints: [
      { lat: 51.506, lng: -0.112 }, // Waterloo
      { lat: 51.503, lng: -0.108 }, // Lambeth
      { lat: 51.499, lng: -0.102 }, // Kennington
    ],
  },
];

export const mockRoutes: FiberRoute[] = (() => {
  const routes: FiberRoute[] = [...LONDON_SEED_ROUTES];
