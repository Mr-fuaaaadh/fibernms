...
const ALL_SECTIONS = {
  ...
  core: {
    ...
    items: [
      ...
      { label: "Auto Design", icon: Cpu, to: "/auto-design" },
  ...
  enterprise: {
    ...
    items: [
      ...
      { label: "Auto Design", icon: Cpu, to: "/auto-design" },
      { label: "Observability", icon: Activity, to: "/monitoring" },
  ...
  admin: {
    ...
    items: [
      ...
      { label: "Settings", icon: Key, to: "/settings/license" },
    ],
  } satisfies NavSection,
